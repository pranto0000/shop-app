        ...
        <div className="navbar-end gap-2">
          ...
          <Link to="cart-page">
            ...
            >
              <div className="indicator">
                ...
                <span className="badge badge-sm indicator-item bg-green border-none text-white">
                  {cart.length || 0 }
                </span>
              </div>
            </label>
          ...
          {user ? (
            ...
            <button
              ...
              className="btn bg-green rounded-full px-6 text-white flex items-center gap-2 border-none hover:bg-slate-400"
            >
              <FaRegUser />
              Login
            </button>
...
//                 />
//               </svg>
//               <span className="badge badge-sm indicator-item">{cart.length || 0 .refetch()}</span>
//             </div>
//           </label>
//          </Link>
